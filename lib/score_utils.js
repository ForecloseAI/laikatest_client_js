...
async function pushScore(
  ...
  // Validate user-provided inputs only
  // Note: exp_id, bucket_id, and prompt_version_id come from getExperimentPrompt()
  // and are already validated by the backend, so we don't need to validate them again
